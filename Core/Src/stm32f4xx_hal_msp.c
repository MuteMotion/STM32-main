...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(Echo3_GPIO_Port, Echo3_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB6     ------> TIM4_CH1
    */
    HAL_GPIO_DeInit(Echo4_GPIO_Port, Echo4_Pin);
  ...
  /* USER CODE END TIM5_MspDeInit 0 */
    ...
    PA0-WKUP     ------> TIM5_CH1
    */
    HAL_GPIO_DeInit(Echo5_GPIO_Port, Echo5_Pin);
  ...
  /* USER CODE END TIM9_MspDeInit 0 */
    ...
    PA2     ------> TIM9_CH1
    */
    HAL_GPIO_DeInit(Echo6_GPIO_Port, Echo6_Pin);
